  ...
  return (
    <>
      ...
      <button 
        ...
        className="w-full mt-3 bg-[#FFA600] hover:bg-[#E09200] text-white font-bold py-2 px-4 rounded-xl text-sm transition shadow-md shadow-orange-100"
      >
        Edit Profile
      </button>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex justify-end gap-3 mt-6 border-t pt-4">
              ...
              <button
                ...
                disabled={loading}
                className="px-5 py-2 text-sm font-bold text-white bg-[#FFA600] hover:bg-[#E09200] rounded-xl transition flex items-center gap-2"
              >
