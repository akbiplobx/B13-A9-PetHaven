    ...
    <Card className="border mx-auto w-full max-w-sm py-6 px-5 mt-5 shadow-lg rounded-2xl">
      ...
      <Form className="flex w-full flex-col gap-3" onSubmit={onSubmit}>
        ...
        <div className="flex gap-2 mt-1">
          <Button 
            type="submit"
            className="bg-[#FFA600] hover:bg-[#E09200] text-white font-bold h-9 text-sm px-4 rounded-lg transition shadow-md flex items-center gap-1"
          >
        ...
        <Button
          ...
          className="w-full font-bold h-9 text-sm border-slate-200 hover:bg-slate-50 rounded-lg flex items-center justify-center gap-2 text-slate-700"
        >
          {!isLoading && (
