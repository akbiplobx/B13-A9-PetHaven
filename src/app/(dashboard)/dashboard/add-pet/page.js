export default function AddPetPage() {
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        <h1 className="text-2xl font-black ">Add a Pet for Adoption</h1>
        <p className="text-sm text-slate-500 font-medium">Fill in the details to find a loving home for a furry friend.</p>
      </div>

      <form className=" p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select className="w-full px-4 py-2.5 border border-slate-200 rounded-xl font-medium text-sm focus:outline-none focus:border-[#FFA600] ">
              <option>Male</option>
